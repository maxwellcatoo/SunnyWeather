...
private val Gsky = mapOf(
    ...
    "雷阵雨并伴有冰雹" to Sky("冰雹", R.drawable.ic_hail, R.drawable.bg_snow),
    "霾" to Sky("轻度雾霾", R.drawable.ic_light_haze, R.drawable.bg_fog),
    "中度霾" to Sky("中度雾霾", R.drawable.ic_moderate_haze, R.drawable.bg_fog),
    "重度霾" to Sky("重度雾霾", R.drawable.ic_heavy_haze, R.drawable.bg_fog),
    "雾" to Sky("雾", R.drawable.ic_fog, R.drawable.bg_fog),
    "浮尘" to Sky("浮尘", R.drawable.ic_fog, R.drawable.bg_fog),
    "未知" to Sky("未知天气", R.drawable.ic_fog, R.drawable.bg_fog)
)

fun getSky(skycon: String): Sky {
//    return sky[skycon]?:sky["CLEAR_DAY"]!!
    return Gsky[skycon]?:Gsky["未知"]!!
}